  ...
  return (
    <>
      <div className="w-full h-screen flex flex-col justify-center overflow-x-scroll">
        ...
        <div className="w-full lg:h-5/6 xl:h-11/12 2xl:h-11/12 flex flex-col gap-2 lg:gap-4 p-4 md:px-44 lg:px-64 xl:px-80 2xl:px-110">
          {/* Top Row */}
          <div className="flex flex-row w-full h-1/4 gap-2 lg:gap-4">
          ...
          {/* Bottom Columns */}
          <div className="flex flex-row h-3/4 w-full gap-2 lg:gap-4">
            <div className="flex flex-col h-full w-8/12 gap-2 lg:gap-4">
              <div className="w-full h-1/4 items-center flex justify-center">
                <HorizontalResultBox />
              </div>
              <div className="w-full h-1/4 items-center flex justify-center">
                <HorizontalResultBox />
              </div>
              <div className="w-full h-2/4 items-center flex justify-center">
                <MediumResultBox />
              </div>
            </div>
            <div className="flex flex-col h-full w-4/12 gap-2 lg:gap-4">
              <div className="w-full h-1/3 items-center flex flex-col justify-center">
                <SmallResultBox />
              </div>
